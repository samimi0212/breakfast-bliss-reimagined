...
export const allProducts: Product[] = [
  ...
  // ---- LE SALÉ ----
  {
    ...
    desc: "",
    composition: ["Tranche de pain au levain", "Sauce onctueuse à l'avocat", "Stracciatella", "Émincé d'avocat", "Jeunes pousses", "Sésame doré", "Saumon fumé"],
  ...
  },
  {
    ...
    desc: "",
    composition: ["Bagel brioché aux graines", "Œuf émietté", "Bacon crispy", "Cheddar", "Sauce Bénédicte"],
