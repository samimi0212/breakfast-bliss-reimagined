...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    desc: "",
    composition: ["Tartine pain au levain", "Caviar d'aubergine artisanal", "Fêta", "Olives Kalamata", "Épices zaatar", "Huile d'olive"],
    composition_en: ["Sourdough tartine", "Artisanal eggplant caviar", "Feta", "Kalamata olives", "Zaatar spices", "Olive oil"],
  },
  {
    id: "breakfast-bowl",
    name: "Breakfast Bowl",
