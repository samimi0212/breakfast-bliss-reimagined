  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        multiSelect: true,
        firstFree: 1,
        choices: ["Nocciolata (+0,50€)", "Sirop d'érable (+0,50€)", "Caramel beurre salé (+0,50€)", "Confiture de fraise (+0,50€)", "Chocolat noir (+0,50€)", "Beurre de cacahuètes Creamy (+0,50€)", "Crème de pistache (+0,50€)"],
        choices_en: ["Nocciolata (+€0.50)", "Maple Syrup (+€0.50)", "Salted Butter Caramel (+€0.50)", "Strawberry Jam (+€0.50)", "Dark Chocolate (+€0.50)", "Creamy Peanut Butter (+€0.50)", "Pistachio Cream (+€0.50)"],
      },
      {
