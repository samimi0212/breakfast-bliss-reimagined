...
export const allProducts: Product[] = [
  // ---- NOS MENUS ----
  {
    ...
    options: [
      ...
      },
      {
        ...
        label_en: "Hot drink",
        required: true,
        choices: ["Café", "Thé Earl Grey citron", "Latte Macchiato (+1,50€)", "Chocolat chaud (+1,50€)"],
        choices_en: ["Café", "Earl Grey Tea", "Latte Macchiato (+€1.50)", "Hot Chocolate (+€1.50)"],
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        required: true,
        multiSelect: false,
        choices: ["Bagel Chèvre Noix", "Bagel Bacon Cheddar", "Bagel Saumon Avocat"],
        choices_en: ["Goat Cheese & Walnut Bagel", "Bacon Cheddar Bagel", "Salmon Avocado Bagel"],
      },
      {
        id: "viennoiserie",
        label: "Viennoiserie",
    ...
    options: [
      {
        ...
        multiSelect: true,
        maxSelect: 2,
        choices: ["Bagel Chèvre Noix", "Bagel Bacon Cheddar", "Bagel Saumon Avocat", "Breakfast Burrito", "Chicken Burrito"],
        choices_en: ["Goat Cheese & Walnut Bagel", "Bacon Cheddar Bagel", "Salmon Avocado Bagel", "Breakfast Burrito", "Chicken Burrito"],
      },
      {
        id: "extra",
        label: "Extra (1 au choix)",
    ...
    options: [
      {
        ...
        required: false,
        multiSelect: false,
        choices: ["Saumon fumé (+2,50€)"],
        choices_en: ["Smoked Salmon (+€2.50)"],
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        required: true,
        multiSelect: false,
        choices: ["Nocciolata", "Sirop d'érable", "Caramel beurre salé", "Confiture de fraise", "Chocolat noir", "Beurre de cacahuètes Creamy", "Crème de pistache"],
        choices_en: ["Nocciolata", "Maple Syrup", "Salted Butter Caramel", "Strawberry Jam", "Dark Chocolate", "Creamy Peanut Butter", "Pistachio Cream"],
      },
      {
        id: "toppings",
  ...
  },
  {
    ...
    img: "/toast-med.png",
    desc: "",
    composition: ["Pain au levain", "Houmous onctueux au Labneh", "Halloumi toasté", "Pois chiches croustillants", "Pousses d'épinards", "Épices zaatar", "Menthe fraîche"],
    composition_en: ["Sourdough bread", "Creamy Labneh Hummus", "Toasted halloumi", "Crispy chickpeas", "Baby spinach", "Zaatar spices", "Fresh mint"],
  },
  {
    id: "breakfast-bowl",
    name: "Breakfast Bowl",
